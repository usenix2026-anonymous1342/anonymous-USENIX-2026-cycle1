...
class VFL_framwork(object):
    ...
    def finetune(self):
        ...
        for idx in range(len(self.bottom_model_list)):
            for param in self.bottom_model_list[idx].parameters():
...
if __name__ == '__main__':
    ...
    result_path = f"./results/{cfg.dataset.name}/active_finetune.csv"
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f'./results/{cfg.dataset.name}/active_finetune.png', dpi=300)