...
def save_passive_target(cfg, top_heap_list):
    for idx, top_heap in enumerate(top_heap_list):
        ...
        save_path = f"./watermark/fidelity/{cfg.dataset.name}/party_{idx}_of_{cfg.dataset.passive_client_num}/"
...
if __name__ == '__main__':
    from config_fidelity_exclusive import config as cfg
