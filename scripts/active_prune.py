...
class VFL_framwork(object):
    ...
    def prune(self, prune_ratio=0.0):
        ...
        prune_attack(self.top_model, prune_ratio)
...
if __name__ == '__main__':
    ...
    result_path = f"./results/{cfg.dataset.name}/active_prune.csv"
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f'./results/{cfg.dataset.name}/active_prune.png', dpi=300)